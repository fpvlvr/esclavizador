...
class TestRefreshTokenRepository:
    ...
    async def test_create_token(self, test_slave):
        ...
        assert refresh_token["user_id"] == test_slave["id"]
    ...
    async def test_get_by_hash_valid_token(self, test_slave):
    ...
    async def test_get_by_hash_revoked_token(self, test_slave):
    ...
    async def test_get_by_hash_expired_token(self, test_slave):
    ...
    async def test_revoke_token(self, test_slave):
    ...
    async def test_cleanup_expired_tokens(self, test_slave):
    ...
    async def test_get_by_id(self, test_slave):
    ...
    async def test_delete_refresh_token(self, test_slave):
