...
class TestRefreshTokenRepository:
    ...
    async def test_get_by_hash_valid_token(self, test_user):
    ...
    async def test_get_by_hash_revoked_token(self, test_user):
    ...
    async def test_get_by_hash_expired_token(self, test_user):
    ...
    async def test_revoke_token(self, test_user):
    ...
    async def test_cleanup_expired_tokens(self, test_user):
    ...
    async def test_get_by_id(self, test_user):
    ...
    async def test_delete_refresh_token(self, test_user):
