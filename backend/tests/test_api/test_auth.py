...
class TestRegisterEndpoint:
    ...
    async def test_register_duplicate_email(self, client, test_worker, test_worker_email):
        """Test registration with existing email returns 409."""
        # test_worker already exists with email from test_worker_email fixture
        response = await client.post("/api/v1/auth/register", json={
            "email": test_worker_email,  # Already exists
            "password": "SecurePass123!",
            "role": "boss",
    ...
    async def test_register_invalid_role(self, client):
        ...
        response = await client.post("/api/v1/auth/register", json={
            ...
            "password": "SecurePass123!",
            "role": "admin",  # Invalid role (should be boss/worker)
            "organization_name": "Test Org"
        })
...
class TestLoginEndpoint:
    ...
    async def test_login_success(self, client, test_worker, test_worker_email, test_worker_password):
    ...
    async def test_login_wrong_password(self, client, test_worker, test_worker_email, test_worker_password):
    ...
    async def test_login_inactive_account(self, client, test_worker, test_worker_email, test_worker_password):
        """Test login with inactive account returns 403."""
        # Make user inactive via repository
        await user_repo.update(test_worker["id"], {"is_active": False})
        ...
        await user_repo.update(test_worker["id"], {"is_active": True})
...
class TestRefreshEndpoint:
    ...
    async def test_refresh_token_success(self, client, test_worker, test_worker_email, test_worker_password):
    ...
    async def test_refresh_token_expired(self, client, test_worker, test_worker_email, test_worker_password):
    ...
    async def test_refresh_token_revoked(self, client, test_worker, test_worker_email, test_worker_password):
...
class TestLogoutEndpoint:
    ...
    async def test_logout_success(self, client, test_worker, test_worker_email, test_worker_password):
    ...
    async def test_logout_then_refresh_fails(self, client, test_worker, test_worker_email, test_worker_password):
...
class TestGetMeEndpoint:
    ...
    async def test_get_me_success(self, client, test_worker, test_worker_email, test_worker_password):
        ...
        assert data["email"] == test_worker_email
    ...
    async def test_get_me_expired_token(self, client, test_worker, test_worker_email, test_worker_password):
        ...
        payload = {
            ...
            "role": test_worker["role"],
            "org_id": str(test_worker["organization_id"]),
            "exp": expire,
    ...
    async def test_get_me_inactive_account(self, client, test_worker, test_worker_email, test_worker_password):
...
class TestRoleBasedAccess:
    ...
    async def test_protected_route_boss_access(self, client, test_boss):
        """Test boss user can access boss-only routes."""
        # Login as boss
        login_response = await client.post("/api/v1/auth/login", json={
    ...
    async def test_protected_route_worker_access(self, client, test_worker, test_worker_email, test_worker_password):
        """Test worker user can access regular protected routes."""
        # Login as worker
        login_response = await client.post("/api/v1/auth/login", json={
            "email": test_worker_email,
            "password": test_worker_password
