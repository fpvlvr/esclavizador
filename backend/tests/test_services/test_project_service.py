...
class TestProjectService:
    ...
    async def test_get_project_wrong_org_raises_404(self, test_user, test_org):
    ...
    async def test_update_wrong_org_raises_404(self, test_master, test_org):
        """Test multi-tenant isolation on update."""
        # Create second org with user and project
        second_org = await Organization.create(name="Second Org")
